...
public class UniversityManagementSystem {
   public static void main(String[] args) {
       // Create professors
       Professor professor1 = new Professor("Dr. Manoj Tyagi");
       Professor professor2 = new Professor("Dr. Vivek Sharma");

       // Create courses
       Course course1 = new Course("Machenical Engineering");
       Course course2 = new Course("Computer Science");
       Course course3 = new Course("Civil");
       ...
       // Create students
       Student student1 = new Student("Kunal");
       Student student2 = new Student("Naman");
